 ...
 */
public class ListPlusComplique {

    private int[] tab;
    private int insertPos = 0;

    public ListPlusComplique(int capacity) {
        tab = new int[capacity];
    }

    public ListPlusComplique() {
        tab = new int[0];
    }
    ...
    public void commonValues(ListPlusComplique otherList) {
        ListPlusComplique commonList = new ListPlusComplique(0);
        for (int i=0; i<tab.length; i++) {
